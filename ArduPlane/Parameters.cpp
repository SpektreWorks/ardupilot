...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Description: Flight mode for switch position 1 (910 to 1360 and above 2049)
    ...
    // @Description: Flight mode for switch position 2 (1361 to 1620)
    GSCALAR(flight_mode2,           "FLTMODE2",       FLIGHT_MODE_2),

    // @Param: FLTMODE3
    // @CopyFieldsFrom: FLTMODE1
    // @DisplayName: FlightMode3
    // @Description: Flight mode for switch position 3 (1621 to 2049)
